...
const Products = () => {
  ...
  const [subscription, setSubscription] = useState({
    ...
    phone: '',
    address: '',
    milkCategory: 'standard' as 'standard' | 'fullCream',
    quantity: 1,
    months: 1,
  ...
  // Milk prices per liter by category
  const MILK_PRICES = { standard: 65, fullCream: 85 };
  const MILK_BASE_PRICE = MILK_PRICES[subscription.milkCategory];
  ...
  const originalTotal = useMemo(
    ...
    [subscription.quantity, subscription.months, MILK_BASE_PRICE]
  );
...
Thank you 🙏`;
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    const milkCategoryLabel = subscription.milkCategory === 'standard' ? 'Standard Milk (₹65/liter)' : 'Full Cream Milk (₹85/liter)';
...
Milk Category: ${milkCategoryLabel}
...
Please confirm my subscription.`;
    ...
    setTimeout(() => {
      window.open(whatsappUrl, '_blank');
      setSubscription({ name: '', phone: '', address: '', milkCategory: 'standard', quantity: 1, months: 1, isFirstTimeCustomer: true });
          ...
          <div className="bg-green-50 rounded-xl shadow-lg p-5 sm:p-8 max-w-2xl mx-auto relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
              <div className="bg-white rounded-lg border border-green-200 px-4 py-3 text-center">
                <p className="font-bold text-green-900">Standard Milk</p>
                <p className="text-green-700 text-sm">₹65/liter</p>
              </div>
              <div className="bg-white rounded-lg border border-green-200 px-4 py-3 text-center">
                <p className="font-bold text-green-900">Full Cream Milk</p>
                <p className="text-green-700 text-sm">₹85/liter</p>
              </div>
            </div>
            ...
            <div className="w-full max-w-lg bg-white rounded-2xl p-6 md:p-8 shadow-xl max-h-[85vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <select
                    value={subscription.milkCategory}
                    onChange={(e) => setSubscription((prev) => ({ ...prev, milkCategory: e.target.value as 'standard' | 'fullCream' }))}
                    className="w-full border border-green-200 rounded p-3 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-400/30 focus:shadow-md transition-shadow"
                    required
                  >
                    <option value="standard">Standard Milk - ₹65/liter</option>
                    <option value="fullCream">Full Cream Milk - ₹85/liter</option>
                  </select>
                </div>
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-green-900">
                  ...
                  <select
                    ...
                    onChange={(e) => setSubscription((prev) => ({ ...prev, quantity: parseInt(e.target.value) }))}
                    className="w-full border border-green-200 rounded p-3 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-400/30 focus:shadow-md transition-shadow"
                    required
                  >
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <div className="text-sm text-green-800 space-y-1">
                    <p>
                      Milk: <span className="font-semibold text-green-900">{subscription.milkCategory === 'standard' ? 'Standard' : 'Full Cream'} (₹{MILK_BASE_PRICE}/liter)</span>
                    </p>
                    <p>
                      Original Price:{' '}
                      <motion.span
